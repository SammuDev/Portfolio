...
const AboutMe: React.FC = () => {
  const cards = [
    ...
    {id: 3, src:'./imgSkills/react.jpg', alt:'Logo do TypeScript'},
    {id: 4, src:'./imgSkills/styled.jpg', alt:'Logo do Styled-Components'},
    {id: 5, src:'./imgSkills/typescript.jpg', alt:'Logo do Next.Js'},
    {id: 6, src:'./imgSkills/next.jpg', alt:'Logo do Node.Js'},
    {id: 7, src:'./imgSkills/node.jpg', alt:'Logo do Express'},
    {id: 8, src:'./imgSkills/express.jpg', alt:'Logo do React.Js'}
  ];
